...
export const Component = () => {
  ...
  // <html> stays fixed/overflow-hidden (see styles/base.css).
  ...
  return (
    <>
      {!isPhotoRouteUnavailable && (
        <a
          href="#main-content"
          className="af-panel fixed top-2 left-2 z-[100] -translate-y-20 rounded-lg px-4 py-2 shadow-lg transition-transform focus-visible:translate-y-0"
        >
